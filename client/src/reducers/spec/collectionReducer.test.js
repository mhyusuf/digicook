  ...
  describe('It should uphold contracts', () => {
    it('Should uphold GET_RECIPE', () => {
      ...
      expect(newState).toEqual({
        ...initialState,
        recipe: mockState.collections.recipe,
      });
    });
    ...
    it('Should uphold GET_RECIPE_LIST', () => {
      ...
      expect(newState).toEqual({
        ...initialState,
        recipeList: mockState.collections.recipeList,
      });
    });
      ...
      expect(newState).toEqual({
        ...
        collectionDetail: {
          ...
          _recipes: testState.collectionDetail._recipes.filter(
            (i) =>
              testState.collectionDetail._recipes[i] !==
    ...
    it('Should uphold GET_COLLECTION_DETAIL', () => {
      ...
      expect(newState).toEqual({
        ...initialState,
        collectionDetail: mockState.collections.collectionDetail,
      });
    });
    ...
    it('Should uphold GET_COLLECTION_LIST', () => {
      ...
      expect(newState).toEqual({
        ...initialState,
        collectionList: mockState.collections.collectionList,
      });
    });
