...
var upload = multer_1.default({
    ...
    fileFilter: function (req, file, cb) {
        if (!file.originalname.match(/\.(jpg|jpeg|png|gif|svg|tiff)$/)) {
            return cb(new Error('Unrecognized file extension. Supported file types are jpg, jpeg, png, gif, svg, tiff.'));
        }
        cb(null, true);
    }
});
...
module.exports = { upload: upload, processImage: processImage };
